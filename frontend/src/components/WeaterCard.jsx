...
import { getWeatherAsync, selectWeather } from "../features/home/homeSlice";
    ...
    <Card>
      <div className="cardContainer">
        <div className="card">
          ...
          <p className="temp">{ Math.round(Number(weather?.main.temp) -  273.15)}°</p>
          <div className="minmaxContainer">
            <div className="min">
              <p className="minHeading">Min</p>
              <p className="minTemp">{Math.round(Number(weather?.main.temp_min) -  273.15)}°</p>
            </div>
            <div className="max">
              <p className="maxHeading">Max</p>
              <p className="maxTemp">{ Math.round(Number(weather?.main.temp_max) -  273.15)}°</p>
            </div>
          </div>
        </div>
      </div>
